...
//immediately after login
		if(empty($exam))
		{
			...
			header("location: results.php?exam=".$exam);
			exit;
		}
...
//getting student name 
		...
		print("
			...
			"<a  href='graph.php'><i class='fa fa-line-chart'></i> Graph of Exams</a><br />
			...
			<div class='header'>
			<h3 align='center'>TERMINAL REPORT</h3>
			...
			<label style='color: #ff0000;float: right;'>Total marks: </label></body>
			</html> 
			");
